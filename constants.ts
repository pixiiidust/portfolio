...
export const PROJECTS: Project[] = [
  {
    ...
    kind: 'project',
    title: 'LKY Avatar',
    detailTitle: 'LKY Avatar: a fictional AI simulation of Mr. Lee Kuan Yew',
    ...
    subject: { label: 'Mr. Lee Kuan Yew', href: 'https://en.wikipedia.org/wiki/Lee_Kuan_Yew' },
    tech: ['Real-Time Voice AI', 'QLoRA + TTS Fine-Tuning + LiveKit'],
    links: [
      { label: 'VIDEO', href: 'https://youtu.be/4UbtvGy9HNk' },
      { label: 'AVATAR CODE', href: 'https://github.com/pixiiidust/lky-avatar' },
      { label: 'BRAIN CODE', href: 'https://github.com/pixiiidust/lky-brain' },
      { label: 'VOICE CODE', href: 'https://github.com/pixiiidust/lky-voice' },
    ...
    insight: 'The interesting question is not whether AI can merely sound like a historical figure. It is whether a model can learn a recognizable reasoning process: reframing questions, arguing from first principles, using concrete analogies, weighing interests over sentiment, bounding uncertainty, and answering directly.',
    problem: 'Mr. Lee Kuan Yew (1923–2015) was Singapore\'s founding prime minister, serving from 1959 to 1990. I chose him as the test case because his speeches and interviews provide a large public record of a distinctive, pragmatic way of working through trade-offs. The experiment examines his reasoning as a reproducible method, not as an endorsement of his politics.',
    approach: 'First, I translated the reasoning style into six observable moves and QLoRA fine-tuned Qwen3-14B on speeches and interviews, with retrieval over a hand-audited fact sheet. I then added a Chatterbox TTS voice LoRA trained on about 23 minutes of real speech, Deepgram transcription, LiveKit with barge-in, and an animated portrait. The experience carries a persistent on-screen disclosure, and every generated audio response is watermarked.',
